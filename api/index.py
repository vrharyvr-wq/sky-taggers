...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "41450"  # Playfab Title Id
        self.SecretKey: str = "S17OBQ54MO4744BQHYZU3GBSO5MFM34J9NXJNR8DYEJJZ8D3NF"  # Playfab Secret Key
        self.ApiKey: str = "OC|1250388141491702|ba90b86dda14df45f83cfd3e44100bf6"  # App Api Key (Oculus/Graph API)
...
def titledata():
    response_data = {
        ...
        "MOTD": "<color=#FFC0CB>WELCOME TO CHRISTMAS TAG!</color>\n\n<color=#0099c2>CURRENT UPDATE: SNOWBALLFIGHT25</color>\n<color=#cacfd2>OWNERS: CREW, ZENON</color>\n<color=#41ff80>ZENON SO TUFF BRU</color>\n<color=#6417ff>OUR DEVELOPERS ARE: ZENON</color>\n<color=#ac1a00>CREDITS: TO APKI, AML</color>\n\n<color=#91A3B0>yuh</color>",
